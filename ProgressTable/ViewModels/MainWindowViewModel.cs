...
namespace ProgressTable.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="student1", Visual=1, Architecture=1, Networks=1, Calculate_Math=2, PI=1, Math=0, Electric=1},
                new Student{Name="student2", Visual=2, Architecture=2, Networks=0, Calculate_Math=2, PI=2, Math=2, Electric=1},
                new Student{Name="student3", Visual=0, Architecture=2, Networks=1, Calculate_Math=1, PI=1, Math=2, Electric=1},
            };
            CheckAverage(students);
